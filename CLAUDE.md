...
This project is indexed by GitNexus as **aigency-monorepo** (2554 symbols, 4096 relationships, 180 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
